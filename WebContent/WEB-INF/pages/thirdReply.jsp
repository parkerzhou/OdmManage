	...
	<div
		...
		<ul style="list-style: none;">
			<li style="margin-bottom: 15px; list-style: none;">
				<form action="SaveQA?solveid=${alterquestion.solve.id }&quesid=${alterquestion.id }"
					method="POST">
					<table>
						<tr>
						...
						<tr>
							<td><strong>责任部门:</strong> ${alterquestion.dept.name}
							</td>
						</tr>
						<tr>
							<td><strong>问题分类:</strong> ${alterquestion.sort.name}
							</td>
						</tr>
						<tr>
						...
						<tr>
							<td><strong>异常状态:</strong> ${sstate}</td>
						</tr>
						<tr>
						...
						<tr>
							<td><strong>根本措施：</strong>${alterquestion.solve.basic_method }</td>
						</tr>
						<tr>
							<td><strong>计划完成日期：</strong> ${plan_time }</td>
						</tr>
						
						<tr>
							<td><strong>QA确认：</strong> <select name="QAcomfirm"
								style="width: 155px">
